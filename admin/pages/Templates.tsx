...
export const Templates: React.FC = () => {
  ...
  return (
    <div className="p-2 sm:p-4 md:p-8 max-w-7xl mx-auto animate-fade-in pb-20 transition-colors duration-300">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-200 dark:border-slate-800 p-4 sm:p-6 mb-6 sm:mb-8 transition-all">
        <label className="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-2 uppercase tracking-tight">
      ...
      {/* Categories Tabs */}
      <div className="sticky top-0 z-10 bg-gray-50/80 dark:bg-slate-950/80 backdrop-blur-md py-2 -mx-2 px-2 sm:mx-0 sm:px-0 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 pb-20">
        {(Object.keys(PHRASE_BANK[activeCategory]) as BotArchetype[]).map((archetype) => {
          ...
          return (
            <div key={archetype} className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 overflow-hidden flex flex-col shadow-sm hover:shadow-md transition-all duration-300">
              <div className="px-4 py-3 bg-gray-50 dark:bg-slate-800/50 border-b border-gray-100 dark:border-slate-800 flex items-center justify-between">
                ...
                <Quote size={14} className="opacity-20 text-slate-400" />
              </div>
                ...
                {phrases.map((phrase, idx) => {
                  ...
                  return (
                    <div 
                      ...
                      className="group relative p-3 rounded-lg bg-gray-50 dark:bg-slate-950 hover:bg-brand-50 dark:hover:bg-brand-900/20 border border-transparent hover:border-brand-200 dark:hover:border-brand-800 cursor-pointer transition-all duration-200"
                    >
